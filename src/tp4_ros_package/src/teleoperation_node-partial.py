...
class Teleoperation_Node:
	...
	while not rospy.is_shutdown():
		...
		self.msg.linear.x = 0.5*self.coeff # 20 [length unit]/[time unit]
		...
		self.msg.angular.z = -2*self.coeff # -0.5236 rad/[time unit]
		self.pub.publish(self.msg)          # publish to '/cmd_vel_mux/input/navi'
		...
		self.msg.angular.z = 2*self.coeff # 0.5236  rad/[time unit]
		self.pub.publish(self.msg)         # pusblish to '/cmd_vel_mux/input/navi'
